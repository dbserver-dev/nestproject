        ...
        <tbody>
          <template v-if="totalcnt > 0">
            <template v-for="item in noticelist" :key="item.ntc_no">
              <tr>
                <td @click="noticemodofy(item.ntc_no)">{{ item.ntc_no }}</td>
                <td @click="noticemodofyfile(item.ntc_no)">
                  {{ item.ntc_title }}
                </td>
...
export default {
  ...
  methods: {
    ...
    excel: function () {
      ...
      this.axios({
        url: "/sampletest/noticeexcelDown.do", // File URL Goes Here
        data: params,
        method: "POST",
        responseType: "blob",
      }).then((res) => {
    ...
    pdf: function () {
      ...
      this.axios({
        url: "/sampletest/noticepdfDown.do", // File URL Goes Here
        data: params,
        method: "POST",
        responseType: "blob",
      }).then((res) => {
